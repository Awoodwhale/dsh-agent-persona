...
.wsp-row-head { display: flex; align-items: center; gap: 8px; padding: 10px 12px 8px; min-height: 46px; box-sizing: border-box; flex-wrap: wrap; border-radius: 12px 12px 0 0; }
...
.wsp-scope-lines { display: flex; flex-direction: column; gap: 5px; padding: 4px 12px 12px 40px; }

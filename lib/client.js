...
.wsp-rail-item:hover { background: var(--wsp-surface-2); color: var(--wsp-text); }
...
.wsp-rail-item-on { background: var(--wsp-surface); color: var(--wsp-text); font-weight: 500; box-shadow: 0 1px 1px rgba(0, 0, 0, 0.03); }
...
.wsp-card-panel { display: flex; flex-direction: column; gap: 14px; padding: 18px 20px 20px; border: 1px solid var(--wsp-line); border-radius: 14px; background: var(--wsp-surface); box-shadow: 0 1px 2px rgba(0, 0, 0, 0.04); transition: border-color 150ms ease; }
.wsp-card-head { display: flex; align-items: center; gap: 10px; flex-wrap: wrap; }
...
.wsp-mono { font-family: var(--dsw-font-markdown-code-font-family, ui-monospace, monospace); font-size: 12px; word-break: break-all; }
...
`
    ...
    class PersonaView extends React.Component {
      constructor(props) {
        super(props === undefined || props === null ? {} : props)
        this.state = { loading: true, data: null, error: '', busy: '', draft: null, showPrompt: false, editing: false, copied: false, tab: 'persona' }
      }

...
.wsp-view { display: flex; flex-direction: column; overflow: auto; height: 100%; box-sizing: border-box; padding: 24px 18px 36px; width: 100%; align-self: center; }
/* Fluid column: it fills the conversation panel and only caps on very wide windows. */
.wsp-shell { display: flex; flex-direction: column; gap: 20px; width: 100%; max-width: 1280px; margin-inline: auto; }
...
.wsp-prose { font-size: 13px; line-height: 1.75; color: var(--wsp-text); max-width: 92ch; }
...
@media (max-width: 640px) {
  ...
  .wsp-shell { gap: 16px; }
  .wsp-view { padding: 18px 14px 28px; }

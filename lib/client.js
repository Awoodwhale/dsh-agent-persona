      ...
      renderBody() {
        ...
        const header = h('div', { className: 'wsp-head', key: 'head' }, [
          h('div', { className: 'wsp-head-top', key: 'top' }, [
            h('span', { className: 'wsp-title', key: 't' }, [h(IconAgentPresetOutline16, { key: 'i' }), 'Agent人设']),
            view === undefined ? null : h(Badge, { key: 'b', tone: view.counts.enabled > 0 ? 'on' : undefined }, `${view.counts.total} 条人设 · ${view.counts.enabled} 条在用`),
          ]),
          h('p', { className: 'wsp-sub', key: 's' }, DESCRIPTION),
          h('div', { className: 'wsp-meta', key: 'm' }, view === undefined
            ? ['正在读取人设…']
            : ['人设保存在 ', h('code', { key: 'c' }, view.storePath)]),
        ])

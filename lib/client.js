...
.wsp-chip-mode { color: var(--wsp-accent); border-color: color-mix(in srgb, var(--wsp-accent) 40%, transparent); background: color-mix(in srgb, var(--wsp-accent) 12%, transparent); }
.wsp-chip-mode-strong { color: var(--wsp-accent); border-color: color-mix(in srgb, var(--wsp-accent) 60%, transparent); background: color-mix(in srgb, var(--wsp-accent) 24%, transparent); font-weight: 500; }

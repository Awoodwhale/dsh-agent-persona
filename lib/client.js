      ...
      render() {
        ...
        const header = h('header', { className: 'wsp-view-head', key: 'head' }, [
          h('div', { className: 'wsp-view-headtext', key: 't' }, [
            ...
            h('p', { className: 'wsp-view-lead', key: 'p' }, '这条会话的人设、实际发送的提示词，以及全部人设的管理。'),
          ]),
        ...
        return h('div', { className: 'wsp-view', 'data-plugin': NS, 'data-host': this.props?.host === 'sidebar' ? 'sidebar' : undefined },

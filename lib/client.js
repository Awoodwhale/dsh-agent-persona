...
.wsp-view { display: flex; flex-direction: column; overflow: auto; height: 100%; box-sizing: border-box; padding: 28px 24px 40px; }
.wsp-shell { display: flex; flex-direction: column; gap: 20px; width: 100%; max-width: 880px; margin-inline: auto; }
...
.wsp-tabs { display: inline-flex; align-self: flex-start; gap: 4px; padding: 4px; border: 1px solid var(--wsp-line); border-radius: 12px; background: rgba(128, 128, 128, 0.12); }

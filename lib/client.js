...
.wsp-view { display: flex; flex-direction: column; overflow: auto; height: 100%; box-sizing: border-box; padding: 28px 24px 40px; width: 100%; max-width: 1040px; margin-inline: auto; align-self: center; }
.wsp-shell { display: flex; flex-direction: column; gap: 20px; width: 100%; max-width: 820px; margin-inline: auto; }
...
.wsp-tabs { display: inline-flex; align-self: center; gap: 4px; padding: 4px; border: 1px solid var(--wsp-line); border-radius: 12px; background: rgba(128, 128, 128, 0.12); }
.wsp-tab { padding: 6px 16px; border: 0; border-radius: 9px; background: transparent; font: inherit; font-size: 13px; color: var(--wsp-muted); cursor: pointer; transition: background 150ms ease, color 150ms ease, box-shadow 150ms ease; }
    ...
    class PersonaView extends React.Component {
      ...
      render() {
        ...
        return h('div', { className: 'wsp-view', 'data-plugin': NS },
          h('div', { className: 'wsp-shell' }, [header, tabs, ...alerts, panel]))
      }
    }

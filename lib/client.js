...
.wsp-tabs { display: inline-flex; gap: 4px; padding: 3px; border: 1px solid var(--wsp-line); border-radius: 12px; background: rgba(128, 128, 128, 0.12); }
.wsp-tab { padding: 5px 14px; border: 0; border-radius: 9px; background: transparent; font: inherit; font-size: 13px; color: var(--wsp-muted); cursor: pointer; transition: background 150ms ease, color 150ms ease, box-shadow 150ms ease; }

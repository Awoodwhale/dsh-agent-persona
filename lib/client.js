...
@media (prefers-reduced-motion: reduce) { .wsp-skel-line, .wsp-panel-area, .wsp-shell > .wsp-view-head, .wsp-shell > .wsp-tabs { animation: none; } .wsp-tab, .wsp-card-panel, .wsp-form-text, .wsp-switch-item { transition: none; } }

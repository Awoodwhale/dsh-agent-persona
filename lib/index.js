 ...
 */
export const collectTargets = async (ctx, warn = () => {}) => {
...
markRemote(WorkspacePersonaService, [
  'listPersonas', 'savePersona', 'deletePersona', 'movePersona', 'duplicatePersona', 'listTargets', 'tunePersona', 'listModels',
])
...
export function apply(ctx, config = {}) {
  ...
  const runtime = {
    ...
    async targets() {
      return collectTargets(ctx, warn)
    },
